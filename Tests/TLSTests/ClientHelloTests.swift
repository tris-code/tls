...
class ClientHelloTests: TestCase {
    ...
    func testClientHello() {
        do {
            let stream = InputByteStream(ClientHelloTests.bytes)
            ...
            assertEqual(
                ...
                .supportedGroups(Extension.SupportedGroups(values: [
                    .secp256r1,
                    .secp521r1,
                    .brainpoolP512r1,
                    .brainpoolP384r1,
            ...
            assertEqual(hello.extensions[safe: 3], .sessionTicket(Extension.SessionTicket(data: [])))

            assertEqual(hello.extensions[safe: 4], .signatureAlgorithms(Extension.SignatureAlgorithms(values: [
            ...
            assertEqual(hello.extensions[safe: 5], .statusRequest(Extension.StatusRequest(certificateStatus: .ocsp)))

            assertEqual(hello.extensions[safe: 6], .heartbeat(Extension.Heartbeat(mode: .allowed)))
